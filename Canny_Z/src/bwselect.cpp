...
//
// Arguments    : const boolean_T varargin_1[640000]
//                const emxArray_real_T *varargin_2
//                const emxArray_real_T *varargin_3
//                boolean_T varargout_1[640000]
// Return Type  : void
//
void bwselect(const boolean_T varargin_1[640000], const emxArray_real_T
*varargin_2, const emxArray_real_T *varargin_3, boolean_T
    ...
    emxArray_real_T *b_r;
    static boolean_T b_varargin_1[640000];
