...
//
// Arguments    : boolean_T E[640000]
//                const float dx[640000]
//                const float dy[640000]
//                const float magGrad[640000]
//                const double lowThresh_data[]
//                const double highThresh_data[]
//                boolean_T H[640000]
// Return Type  : void
//
void thinAndThreshold(boolean_T E[640000], const float dx[640000], const float
dy[640000], const float magGrad[640000], const double
                      lowThresh_data[], const double highThresh_data[],
                      boolean_T H[640000]) {
    int jj;
    double sz[2];
    emxArray_int32_T *ii;
    static boolean_T bv1[640000];
    ...
    for (jj = 0; jj < 640000; jj++) {
        bv1[jj] = (magGrad[jj] > highThresh_data[0]);
    }
    ...
    jj = 0;
    exitg1 = false;
    while ((!exitg1) && (jj + 1 <= 800)) {
        guard1 = false;
        if (bv1[b_ii + 800 * jj] && E[b_ii + 800 * jj]) {
            idx++;
    ...
    if (!(idxStrongC->size[0] == 0)) {
        ...
        memset(&H[0], 0, 640000U * sizeof(boolean_T));
    }
